...
import { IconText, TextButton } from "@/components/Lv2_Molecules";
import { $cx } from "@/lib";
    ...
    <div>
      <div>
        <div>
          ...
          <IconText text="Est et in pharetra magna adipiscing ornare aliquam." />
          <IconText text="Tellus arcu sed consequat ac velit ut eu blandit." />
          <IconText text="Ullamcorper ornare in et egestas dolor orci." />
        </div>
