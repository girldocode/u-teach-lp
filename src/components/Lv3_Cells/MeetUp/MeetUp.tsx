...
import meetImage from "../../../../public/assets/svgviewer-output (0010).svg";
...
const MeetUp = () => {
  const classes = {
    ...
    left: $cx(styles.section__left),
    img: $cx(styles.section__left__img),
    right: $cx(styles.section__right),
    textContainer: $cx(styles.section__right__textContainer),
    title: $cx(styles.section__right__textContainer__title),
    desc: $cx(styles.section__right__textContainer__desc),
    button: $cx(styles.section__right__textButton),
  };
    ...
    <section className={classes.section}>
      <div className={classes.container}>
        <div className={classes.left}>
          <Image src={meetImage} alt="Meet Image" className={classes.img} />
        </div>
        <div className={classes.right}>
          ...
          <div className="display-flex items-center mt-8">
            ...
            >
              <span
                className={`display-flex items-center gap-x-2 ${classes.button}`}
              >
